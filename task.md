# Portfolio rebuild tasks

1. `DONE` — Establish Vite/React static structure and GitHub Pages build configuration.
2. `DONE` — Create shared tokens, global styles, and responsive layout matching the wireframe.
3. `DONE` — Build navigation, hero, theme toggle, and profile presentation.
